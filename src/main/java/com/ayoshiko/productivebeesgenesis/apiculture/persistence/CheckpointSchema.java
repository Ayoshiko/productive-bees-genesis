...
final class CheckpointSchema {
	...
	private static Map<Kind, Map<String, Field>> definitions() {
		...
		define(result, Kind.OWNERSHIP, "claim:CLAIM phase:s assets:RAW fingerprint:s failure:s");
	...
	static final class Node {
		...
		Object finish() {
			...
			return switch (kind) {
				...
				case OWNERSHIP -> new com.ayoshiko.productivebeesgenesis.apiculture.ownership.OwnedMachineRecord(value("claim"), choice("phase", com.ayoshiko.productivebeesgenesis.apiculture.ownership.OwnedMachineRecord.Phase.class), new com.ayoshiko.productivebeesgenesis.apiculture.ownership.AssetImage(value("assets")), string("fingerprint"), string("failure"));
