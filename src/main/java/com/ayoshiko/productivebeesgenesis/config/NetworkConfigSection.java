...
public final class NetworkConfigSection {
	...
	public final ModConfigSpec.LongValue maintenanceFe;
	...
	NetworkConfigSection(ModConfigSpec.Builder builder) {
		...
		maintenanceFe = builder.translation("productivebeesgenesis.configuration.bee_network.maintenanceFe").comment("每网每个成功推进新工作的真实 tick 的维护 FE；不因成员数或加速重复收费，不补扣休眠时间。研发默认 0，费率待平衡测试确定。").defineInRange("maintenanceFe", 0L, 0L, Long.MAX_VALUE);
